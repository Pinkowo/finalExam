...
import ch from '../json/english.json';
      ...
      return (      
        ...
        <View style={styles.headerCenter}>
          <View>
            ...
            <View>
              <Image source={require('../assets/pics/english.png')} style={styles.headerTitlePic}/>
            ...
            [
              {
                text: '了解',
                onPress: () => 
                {setText('');setAllQ(allQ+1);setNo(allQ);setAns(ch[no+1].ans);global.score.enS+=1;}
              }
            ],
            { cancelable: false }
          );
