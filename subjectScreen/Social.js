...
import ch from '../json/social.json';
      ...
      return (      
        ...
        <View style={styles.headerCenter}>
          <View>
            ...
            <View>
              <Image source={require('../assets/pics/social.png')} style={styles.headerTitlePic}/>
            ...
            [
              {
                text: '了解',
                onPress: () => 
                {setText('');setAllQ(allQ+1);setNo(allQ);setAns(ch[no+1].ans);global.score.soS+=1;}
              }
            ],
            { cancelable: false }
          );
